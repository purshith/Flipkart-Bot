...
BOT_TOKEN = environ.get('BOT_TOKEN',"6924756046:AAGiDtvcXRgOorhpqEPWrF_m9UJKA9Urgrs")  # Token used by telegram to authorize the use of bot; replace with your token
...
def Telegram():
  ...
  async def send_welcome(message: types.Message):
    await message.answer(
      f"""Hi! {message['from']['first_name']} \n Welcome You to Flipkart Product Price Tracker Bot. You can track the price of Flipkart Product by sending the link.\n"""
    )
